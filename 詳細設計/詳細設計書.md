...
classDiagram
    ...
    class ProductController {
        ...
        +getProductList(): List~ProductListItem~
        +getProductDetail(Long id): ProductDetail
    }
    ...
    ProductService --> ProductListItem : converts to
    ProductService --> ProductDetail : converts to
...
classDiagram
    ...
    class CartController {
        ...
        +addItem(CartItemQuantityDto)
        +removeItem(Long productId)
        +updateItem(CartItemQuantityDto)
        +getCart(): Cart
    }

    %% Service
    class CartService {
        +addToCart(Long productId, int quantity)
        +removeFromCart(Long productId)
        +updateQuantity(Long productId, int quantity)
        +getCart(): Cart
    }
