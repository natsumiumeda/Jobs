...
classDiagram
    class AdminController {
        ...
        +updateProfile(CustomerUpdateRequest, HttpSession) 
    }
...
AdminController --> AdminUser : uses
AdminController ..> LoginRequest : receives
AdminUser "1" -- "*" Order : manages
Order --> OrderStatus : summarizedAs
OrderStatus --> OrderItem : contains
