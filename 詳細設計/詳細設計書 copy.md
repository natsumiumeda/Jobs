...
classDiagram
    class CartController {
        ...
        +addItemToCart(CartItemInfo, HttpSession)
        +updateItemQuantity(itemId, CartItemQuantityDto, HttpSession)
        +removeItem(itemId, HttpSession)
    }

    class CartService {
        +getCart(HttpSession) : Cart
        +addItem(productId, quantity, HttpSession)
        +updateQuantity(itemId, newQty, HttpSession)
        +removeItem(itemId, HttpSession)
        +calculateTotal(cart)
    }
...
classDiagram
    class OrderController {
        ...
        +placeOrder(HttpSession) ResponseEntity~OrderResultDto~
        +getOrderHistory(HttpSession) ResponseEntity~List~OrderSummaryDto~~
    ...
    class OrderService {
        ...
        +ProductRepository productRepository
        +placeOrder(HttpSession) OrderResultDto
        +getOrderHistory(HttpSession) List~OrderSummaryDto~
    ...
    class OrderRepository {
        ...
        +findByUserId(HttpSession) List~Order~
